...
update tb_categorias set desconto = 0.05 where id = 7;
 ...
 #mudança de desconto, porem observar o valor no qual esta dando esse desconto para cada categoria
update tb_categorias set desconto = 0.05 where id != 7;

#o CHANGE usa muito com mudnaças e erros ortograficos qd esta estruturando os dados do banco
alter table tb_categorias change desconto desconto_thi decimal(4,2);

describe tb_categorias;

#remover comando da tabela.Apaga todos os dados e registro alterados na tabela.
...
#buscar por dados, nome, sentença, LIKE so trabalha com string, sigla qual for sua busca.
